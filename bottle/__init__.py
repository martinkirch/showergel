...
Copied to showergel from https://github.com/bottlepy/bottle/raw/master/bottle.py
until it's a stable release of 0.13, at least
see https://github.com/martinkirch/showergel/issues/12
